...
import { authenticate, isSalesExecutive, isSuperAdmin } from "../middlewares/authMiddleware.js";

const router = Router();

router.post("/register", authenticate, isSuperAdmin, registerSalesExecutive);
router.get("/get-sales-executive-by-city/:cityId", authenticate, isSuperAdmin, getSalesExecutivesByCity);
router.get("/all-sales-executives", authenticate, isSuperAdmin, getAllSalesExecutives);

router.get("/dashboard-stats", authenticate, isSalesExecutive, getSalesExecutiveDashboardStats);
